...
@section('title')
<title>{{$getdata->judul_berita}} | Kabupaten Tangerang</title>
@stop
	@section('content')
			<div class="container">
												...
												@if($getdata->id_berita!=$key->id_berita)
													<li>
														<div class="post small-post">
															...
															<div class="post-content">
																<div class="video-catagory"><a href="{{url('/')}}/{{$singkatan}}/detail-konten-skpd/show-berita-skpd/{{$key->id_berita}}/{{$key->id_skpd}}">{{$key->nama_kategori}}</a></div>
																<h2 class="entry-title">
