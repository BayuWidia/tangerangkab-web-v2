...
@section('title')
<title>Hasil Pencarian : {{$param}} | Web Kabupaten Tangerang</title>
@stop

@section('content')
	<div class="container">
			<div class="page-breadcrumbs">
				<h1 class="section-title">Hasil Pencarian : <i>{{$param}}</i></h1>
			</div>
			<div class="section">
				<div class="row">
					<div class="col-sm-9">
								...
								<div class="post">
										<div class="entry-header">
											<div class="entry-thumbnail">
												...
												@else
													<img class="img-responsive" src="{{ asset('/images/'.$key->url_foto) }}" alt="" />
												@endif
											</div>
										</div>
										<div class="post-content">
											...
											<h2 class="entry-title">
												@if (isset($singkatan))
													<a href="{{url('/')}}/{{$singkatan}}/detail-konten-skpd/show-berita-skpd/{{$key->id}}/{{$key->id_skpd}}">{{ $key->judul_berita }}</a>
												@else
											...
											<div class="entry-content">
												@if (isset($singkatan))
													<a href="{{url('/')}}/{{$singkatan}}/detail-konten-skpd/show-berita-skpd/{{$key->id}}/{{$key->id_skpd}}">
												@else
