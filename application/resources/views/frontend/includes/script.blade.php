  ...
  <script type="text/javascript" src="{{ asset('theme/js/jquery.simpleWeather.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('theme/js/jquery.sticky-kit.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('theme/js/jquery.easy-ticker.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('theme/js/jquery.subscribe-better.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('theme/js/main.js') }}"></script>
  <script type="text/javascript" src="{{ asset('theme/js/switcher.js') }}"></script>
  @yield('script')
