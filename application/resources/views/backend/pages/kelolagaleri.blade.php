          ...
          <div class="modal-body">
            <div class="col-md-14">
              ...
              <div>
                ...
                <span class="text-muted"><i>* Rekomendasi ukuran terbaik: 200 x 122 px.</i></span>
              </div>
            </div>
            <div class="col-md-14">
        ...
        <div class="box box-success box-solid">
          ...
          <div class="box-body">
              ...
              @if ($errors->has('url_gambar'))
                <div>
                  <span class="help-block">
                    <i>* {{ $errors->first('url_gambar') }}</i>
                  </span>
                </div>
              @endif
            </div>
            <div class="col-md-14 {{ $errors->has('keterangan_gambar') ? 'has-error' : '' }}">
              <label class="control-label">Keterangan</label>
              <textarea name="keterangan_gambar" rows="4" cols="40" class="form-control">@if(!$errors->has('keterangan_gambar')){{old('keterangan_gambar')}}@endif</textarea>
              @if ($errors->has('keterangan_gambar'))
                <div>
                  <span class="help-block">
                    <i>* {{ $errors->first('keterangan_gambar') }}</i>
                  </span>
                </div>
              @endif
            </div>
            <div class="col-md-14">
              <label class="control-label">Status</label>
              <select class="form-control" name="flag_gambar">
                <option value="1" {{ old('flag_gambar')==1 ? 'selected' : '' }}>Aktif</option>
                <option value="0" {{ old('flag_gambar')==0 ? 'selected' : '' }}>Tidak Aktif</option>
              </select>
            </div>
          </div>
