  ...
  <body class="skin-blue-light hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Silahkan Set Password Anda</p>
        <form action="{{route('setpassword')}}" method="post">
          {!! csrf_field() !!}
          <div class="form-group has-feedback">
            <input name="email" type="text" class="form-control" placeholder="email" value="{{$email}}" readonly>
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Set Password Saya</button>
            </div>
          </div>
        </form>
