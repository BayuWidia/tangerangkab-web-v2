...
@section('breadcrumb')
  <h1>
    Grafik Berita
    <small>Jumlah Berita SKPD</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active">Lihat Grafik Berita</li>
  </ol>
@stop
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-3 col-xs-12">
      ...
      <div class="small-box bg-maroon">
        <div class="inner">
          <h3>{{$getberitasdhpublish}}</h3>
          <p>Jumlah Berita Sudah Dipublish</p>
        </div>
        <div class="icon">
    ...
    <div class="col-lg-4 col-md-3 col-xs-12">
      ...
      <div class="small-box bg-purple">
        <div class="inner">
          <h3>{{$getberitaall}}</h3>
          <p>Jumlah Berita Yang Telah Dibuat</p>
        </div>
        <div class="icon">
          <i class="fa fa-tv"></i>
        </div>
        <a href="{{route('berita.lihat')}}"
    ...
    <div class="col-lg-4 col-md-3 col-xs-12">
      ...
      <div class="small-box bg-yellow">
        <div class="inner">
          <h3>{{$getberitablmpublish}}</h3>
          <p>Jumlah Berita Belum Dipublish</p>
        </div>
        <div class="icon">
    ...
    <section class="col-lg-12 col-md-12 connectedSortable">
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="box-footer text-center">
          <a href="{{url('admin/kelola-berita-skpd')}}" class="uppercase btn btn-success">Lihat Seluruh SKPD</a>
        </div><!-- /.box-footer -->
      </div><!-- /.nav-tabs-custom -->
     </section>
  </div>
